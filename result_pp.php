								...
								<div class="tab-content" style="padding: 10px;">
									 <div role="tabpanel" class="tab-pane active" id="Skyscanner">
										...
										<div class="col-xxs-12 col-xs-8">
											...
											<div class="listBox">
												<img src="<?php echo $row->return->image; ?>" style="height:auto; width: 70px; float: left;">

												<div style="width:calc(100% - 70px); float: left;">
													<div class="col-xs-3 depart">
														<span class="times"><?php echo substr($row->return->full_via,11,6); ?></span>
														<span class="stop-station" data-id="10485"><?php echo substr($row->return->full_via,6,3); ?></span>
													</div>

													<div class="col-xs-6 stopBox">
														<div class="stops">
															<span class="duration"><?php echo $row->return->duration; ?></span>
													...
													<div class="col-xs-3 arrive">
														<span class="times"><?php echo substr($row->return->full_via,19,5); ?></span>
														<span class="stop-station" data-id="10485"><?php echo substr($row->return->full_via,0,3); ?></span>
													</div>
												</div>
											</div>
									 ...
									 <div role="tabpanel" class="tab-pane" id="tiketCom">
									 	<div class="row">
											<?php foreach ($formdata->results as $row) {
												if ($row->type == 'sky') { continue; }?>
									 		<div class="col-xs-12 no-padding">
									 			<div class="col-xs-6" style="padding: 2px !important;">
									 				<div class="headResult">PERGI</div>
									 		<div class="resultBox" >
												<img src="<?php echo $row->departure->image; ?>" style="height:auto; width: 70px; text-align:center;">

												<div style="width:100%; float: left; border-bottom: 1px solid #e0dcdc; padding-bottom: 5px;">
													<div class="col-xs-3 depart2">
														<span class="times2"><?php echo substr($row->departure->full_via,11,6); ?></span>
														<span class="stop-station2" data-id="10485"><?php echo substr($row->departure->full_via,0,3); ?></span>
													</div>
													...
													<div class="col-xs-3 arrive2">
														<span class="times2"><?php echo substr($row->departure->full_via,19,5); ?></span>
														<span class="stop-station2" data-id="10485"><?php echo substr($row->return->full_via,6,3); ?></span>
													</div>
												</div>

												<div style="width: 100%; padding-top: 10px; display: inline-block;">
													<div class="col-xs-6 no-padding price2">Rp.<?php echo number_format(intval($row->departure->price),0,',','.') ?></div>
									 			...
									 			<div class="col-xs-6" style="padding: 2px !important;">
									 				...
									 				<div class="resultBox" >
												<img src="<?php echo $row->return->image; ?>" style="height:auto; width: 70px; text-align:center;">

												<div style="width:100%; float: left; border-bottom: 1px solid #e0dcdc; padding-bottom: 5px;">
													<div class="col-xs-3 depart2">
														<span class="times2"><?php echo substr($row->return->full_via,11,6); ?></span>
														<span class="stop-station2" data-id="10485"><?php echo substr($row->return->full_via,0,3); ?></span>
													</div>
													...
													<div class="col-xs-3 arrive2">
														<span class="times2"><?php echo substr($row->return->full_via,19,5); ?></span>
														<span class="stop-station2" data-id="10485"><?php echo($row->return->full_via); ?></span>
													</div>
												</div>
